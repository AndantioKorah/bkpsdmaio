...
<div class="col-md-12">
  ...
  <li class="nav-item nav-item-layanan" role="presentation">
    <button onclick="getFile(file='drh')" class="nav-link nav-link-layanan" id="pills-pangkat-tab" data-bs-toggle="pill" data-bs-target="#pills-pangkat" type="button" role="tab" aria-controls="pills-home" aria-selected="true">DRH</button>
  <li>

  <?php if($id_m_layanan == 37) { ?> 
  <li class="nav-item nav-item-layanan" role="presentation">
    <button onclick="getFile(file='satyalancana_10')" class="nav-link nav-link-layanan" id="pills-pangkat-tab" data-bs-toggle="pill" data-bs-target="#pills-pangkat" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Stayalancana Karya Satya 10 Tahun</button>
  <li>
  <?php } ?>
...
function openPresensiTab(){
  ...
  async function getFile(file){
    ...
    if(file == "skcpns" || file == "skpns"){
          ...
          dir = "arsipjabatan/";
        } else if(file == "satyalancana_10"){
          dir = "arsippenghargaan/";
        } else {
          dir = "uploads/";
        }
