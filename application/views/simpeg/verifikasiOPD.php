			...
			<div class="content container-fluid">
					...
					<div class="row align-items-center">
						<div class="col">
							...
							<ul class="breadcrumb">
								...
								<li class="breadcrumb-item active">Verifikasi Dokumen Kepegawaian OPD </li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="card">
					<div class="card-header">
						<h4 class="card-title mb-0">Verifikasi Dokumen Kepegawaian Berdasarkan NIP Pada Setiap OPD</h4>
					</div>
					<div class="col-lg-12">
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			var table = $('#table').DataTable({
				...
				"deferLoading": 0,
				"ajax": {
					"url": '<?php echo site_url() ?>/arsip/getVerifikasiOPD/',
					"data": function(d) {
						d.cariBy = $('#cariBy').val();
					...
					},
					{
						...
						"render": function(data, type, full, meta) {
							...
							return '<div class="dropdown dropdown-action"><a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>' +
								...
								'<?php if (hasPermission("arsip", "verifikasiOPD")) : ?><a class="dropdown-item" href="#" data-id="' + full.raw_name + '"  data-toggle="modal" data-target="#vskModal"><i class="fa fa-check m-r-5"></i> Approve</a><?php endif ?>' +
								'</div></div>';
						}
					}
				]
			...
			$('#vskModal').on('show.bs.modal', function(e) {
				...
				$.ajax({
					type: "POST",
					url: "<?php echo site_url() ?>/arsip/validasiOPD",
					data: data,
					success: function(r) {
			...
			$("#nBtnVerifikasi").on("click", function(e) {
				...
				$.ajax({
					type: "POST",
					url: "<?php echo site_url() ?>/arsip/approveOPD",
					data: data,
					success: function(r) {
						$('#vskModal #msg').text(r.pesan)
							.removeClass("text-info")
