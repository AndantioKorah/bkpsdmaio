...
<style>
	...
	table {
    font-size: 15px; /* Sets the default font size for all text within the table */
    }
</style>
...
<br>
<span style='font-family:"Arial",sans-serif;'><b>Jumlah Aparatur Sipil Negara (ASN) Pemerintah Kota Manado Menurut Pangkat/Gologan Per Tanggal <?=formatDateNamaBulan(date('Y-m-d'));?></b></span>
<table style="border-collapse: collapse; border: none; width: 100%;border: 1pt solid black;" class="fr-table-selection-hover">
    <tbody>
        <tr style="">
            <td style="width: 5%; border-top: none; border-left: none; border-bottom: 1pt solid black; border-right: 1pt solid black; padding: 0cm 5.4pt;">
