...
<button id="btn_lihat_dok" href="#modal_view_file" onclick="openFilePangkat('<?=$result[0]['gambarsk']?>')" data-toggle="modal" class="btn btn-sm btn-navy-outline">
...
<div class="col-md-12">
  ...
  <li>
  <li class="nav-item nav-item-layanan" role="presentation">
    <button onclick="getFile(file='formulir_cuti')" class="nav-link nav-link-layanan" id="pills-pangkat-tab" data-bs-toggle="pill" data-bs-target="#pills-pangkat" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Formulir Cuti</button>
  </li>
...
function openPresensiTab(){
  ...
  async function getFile(file){
    ...
    dir = "./dokumen_layanan/cuti_besar/";
  ...
  var id_usul = "<?=$id_usul;?>";
   ...
   $.ajax({
        ...
        $('#modal_body').load('<?=base_url("kepegawaian/C_Kepegawaian/loadModalUploadSKCutiBesar")?>'+'/'+id_usul+'/'+id_m_layanan, function(){
          $('#loader').hide()
        })
        }
