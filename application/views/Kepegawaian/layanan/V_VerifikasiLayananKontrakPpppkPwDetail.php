...
<div class="col-md-12">
 ...
 <li class="nav-item nav-item-layanan" role="presentation">
    <button onclick="getFile(file='surat_pernyataan_hd')" class="nav-link nav-link-layanan" id="pills-pangkat-tab" data-bs-toggle="pill" data-bs-target="#pills-pangkat" type="button" role="tab" aria-controls="pills-home" aria-selected="true">SKP</button>
  </li>
...
function openPresensiTab(){
  ...
  async function getFile(file){
    ...
    var dir = "./dokumen_layanan/kontrak_pppk_pw/";
