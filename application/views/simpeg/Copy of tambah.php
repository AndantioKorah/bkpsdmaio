					...
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								...
								<?php echo $data['pesan']?>							
									<form action="<?php echo site_url()?>/simpeg/kirimUsul" method="POST" enctype="multipart/form-data"> 
									<input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>"> 
									
								<table width="1439" border="0" align="left">
                                          <tr>
                                            <td width="9">&nbsp;</td>
                                            <td width="200">Nama</td>
                                            <td width="12">:</td>
                                            <td width="774"><?php echo $data['asn']->gelar1; ?> <?php echo $data['asn']->nama; ?> <?php echo $data['asn']->gelar2; ?></td>
                                            <td width="422" rowspan="16"><div align="center" ><img src="<?php echo base_url()?>uploads/<?=$data['nip_baru']?>/<?=$data['pasphoto']?>" alt="" width="200" align="top"></div>
                                            <p>&nbsp;</p>
                                            <p>&nbsp;</p>
                                            <p>&nbsp;</p></td>
                                          </tr>
							  ...
							  <div class="card-body">	
								...
								<table class="table table-striped table-sm">
                                              ...
                                              <tbody>
                                                <?php $i=1;foreach($data['dokumen']->result() as $value):?>
                                                <tr>
                                                  <td><?php echo $i?></td>
