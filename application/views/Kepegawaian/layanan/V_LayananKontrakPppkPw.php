		...
		<div class="card card-default">
          ...
          <div class="form-group">
           ...
           <div class="form-group mt-2">
            <label>SKP (SKP Triwulan 1 dan 2 tahun 2026 digabung jadi 1 file)</label>
            <input  class="form-control my-image-field" type="file" id="skp_tw" name="file2" required />
          </div>
...
function viewBerkasPangkat(filename,id){
  ...
  // function loadListRiwayatCutiBesar(){
  //   $('#list_riwayat_karsu').html('')
  //   $('#list_riwayat_karsu').append(divLoaderNavy)
  //   $('#list_riwayat_karsu').load('<?=base_url("kepegawaian/C_Kepegawaian/loadListRiwayatCutiBesar/")?>', function(){
  //     $('#loader').hide()
  //   })
  //   }
  ...
  function loadListRiwayatCutiBesar(){
    ...
    $("#rekomendasi_pd").change(function (e) {
      var fileSize = this.files[0].size/1024;
      var MaxSize = 1024

      var doc = rekomendasi_pd.value.split('.')
