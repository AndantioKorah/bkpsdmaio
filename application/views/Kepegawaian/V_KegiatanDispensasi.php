                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4">
                       ...
                       <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="tanggal_surat_permohonan" name="tanggal_surat_permohonan" >
                        </div>
                    </div>
                      <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                     ...
                     <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="tanggal_mulai_kegiatan" name="tanggal_mulai_kegiatan" >
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="tanggal_selesai_kegiatan" name="tanggal_selesai_kegiatan" >
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4">
                     ...
                     <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="kecamatan_kegiatan" name="kecamatan_kegiatan" >
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="kota_kab_kegiatan" name="kota_kab_kegiatan" >
                        </div>
                    </div>
                       ...
                       <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="provinsi_kegiatan" name="provinsi_kegiatan" >
                        </div>
                    </div>
