    ...
    <table class="table table-striped" id="table_list_pegawai">
            ...
            <?php $no=1; foreach($list_pegawai as $p){?>
                <tr>
                    ...
                    type="button"  onclick="loadModalRating('<?=$p['id_peg']?>')" class="btn btn-primary btn-sm open-DetailPT" data-toggle="modal" data-target="#exampleModal">
...
<div   class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content" >
      ...
      <div id="modal_body" class="modal-body" style="background-color: #ffffff;">
...
// }
  ...
  function loadModalRating(id_pegawai){
        $('#modal_body').html('')
        $('#modal_body').append(divLoaderNavy)
        $('#modal_body').load('<?=base_url("simata/C_Simata/loadModalRating")?>'+'/'+id_pegawai, function(){
          $('#loader').hide()
        })
  }
