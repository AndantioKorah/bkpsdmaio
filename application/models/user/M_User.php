<?php
	class M_User extends CI_Model
	{
        ...
        public function searchAllPegawai($data){
            ...
            $this->db->select('j.nama_bidang,a.id_peg,e.id_pangkat,c.jenis_jabatan,a.tgllahir,a.gelar1, a.gelar2, a.nama, c.nama_jabatan, b.nm_unitkerja, c.eselon, d.nm_agama, e.nm_pangkat,
                    ...
                    ->join('m_user i', 'a.nipbaru_ws = i.username')
                    ->join('m_bidang j', 'i.id_m_bidang = j.id')
