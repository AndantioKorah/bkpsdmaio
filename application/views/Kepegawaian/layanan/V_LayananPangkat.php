...
$(function(){
  ...
  loadListRiwayatLayananPangkat()
    ...
    $('#form_karis_karsu').on('submit', function(e){  
        ...
        $.ajax({  
        url:"<?=base_url("kepegawaian/C_Kepegawaian/insertUsulLayananPangkat/6")?>",
        method:"POST",  
        data:form_data,  
        contentType: false,  
        cache: false,  
  ...
  function loadListRiwayatLayananPangkat(){
    ...
    $('#list_riwayat_karsu').load('<?=base_url("kepegawaian/C_Kepegawaian/loadListRiwayatLayanan/6")?>', function(){
      $('#loader').hide()
    })
    }
