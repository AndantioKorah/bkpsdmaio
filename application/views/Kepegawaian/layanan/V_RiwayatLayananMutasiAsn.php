    ...
    <div class="card-body table-responsive">
      ...
      <table class="table table-hover datatable" style="width:100%;">
        <thead>
          ...
          <th class="text-left">Peta Jabatan</th>
        ...
        <tbody>
          ...
          <td class="text-left">
          <button href="#modal_view_file" onclick="openSuratKeterangan('<?=$rs['peta_jabatan']?>')" data-toggle="modal" class="btn btn-sm btn-navy-outline">
          <i class="fa fa-file-pdf"></i></button>
          </td>
          <td>
...
if(id_layanan == 33){
  $link = "<?=base_url();?>dokumen_layanan/mutasiasn/"+filename+"?v="+number;
}
...
var number = Math.floor(Math.random() * 2000);
$link2 = "<?=base_url();?>dokumen_layanan/mutasiasn/"+filename+"?v="+number;

$('#iframe_view_file').attr('src', $link2)
$('#iframe_view_file').on('load', function(){
  $('.iframe_loader').hide()
  $(this).show()
})
