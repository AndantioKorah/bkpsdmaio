  ...
  ?>
          ...
          ?>
            <div class="row">
              ...
              <div class="col-lg-6 text-right">
                <a class="btn btn-sm btn-success" target="_blank" href="<?=base_url().$fileUrl?>"><i class="fa fa-file"></i> LIHAT DOKUMEN</a>
              </div>
            </div>
          <?php } ?>
        </div>
    ...
    <script>
      ...
      $('#btn_generate_ns').on('click', function(){
        ...
        $.ajax({
          url: '<?=base_url("kepegawaian/C_Kepegawaian/saveNomorSuratManual/".$result['id_t_usul_ds']."/1")?>',
          method:"POST",  
