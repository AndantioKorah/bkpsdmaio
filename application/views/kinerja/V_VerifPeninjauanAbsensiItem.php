    ...
    <div class="mt-3">
        <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
            <li class="nav-item">
                ...
                <a class="nav-link active" onclick="openListData(0)" id="custom-content-below-pengajuan-tab" data-toggle="pill" 
            ...
            <!-- <a class="nav-link" onclick="openListData(2)" id="custom-content-below-diterima-tab" data-toggle="pill" 
                ...
                <a class="nav-link" onclick="openListData(1)" id="custom-content-below-diterima-tab" data-toggle="pill" 
            ...
            <li class="nav-item">
                ...
                <a class="nav-link" onclick="openListData(2)" id="custom-content-below-ditolak-tab" data-toggle="pill" 
            ...
            <li class="nav-item">
                ...
                <a class="nav-link" onclick="openListData(3)" id="custom-content-below-batal-tab" data-toggle="pill" 
...
<script>
    ...
    function openListData(status){
        ...
        $('#result_data').load('<?=base_url('kinerja/C_Kinerja/loadSearchVerifPeninjauanAbsensi')?>'+'/'+status+'/'+$('#bulan').val()+'/'+$('#tahun').val()+'/'+$('#id_unitkerja').val(), function(){
            $('#loader').hide()
        })
    }
