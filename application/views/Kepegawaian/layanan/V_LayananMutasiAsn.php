...
<div class="col-lg-12 mt-3">
	...
	<div class="col-lg-12">
		<div class="card card-default">
            ...
            <input type="hidden" id="peta_jabatan" value="<?php if($peta_jabatan) echo $peta_jabatan['id']; else echo "";?>">
             ...
             <div class="col-lg-12 col-md-12 mt-2 mb-2">
                    ...
                    <select required class="form-control select2-navy select2 mb-2" style="width: 100%"
          ...
          <div class="form-group mb-2">
            <label>Surat rekomendasi asal dan tujuan perangkat daerah</label>
        ...
        <div class="form-group">
            <label>Peta jabatan asal dan tujuan perangkat daerah yang ditandatangani Kepala Perangkat Daerah dan Kepala Bagian Organisasi</label>
...
$(function(){
  ...
  loadListRiwayatMutasiPidahMasuk()
    ...
    $('#form_mutasi_pindah_masuk').on('submit', function(e){  
        ...
        $.ajax({  
        url:"<?=base_url("kepegawaian/C_Kepegawaian/insertUsulLayananMutasiAsn/")?>"+id_m_layanan,
        method:"POST",  
        data:form_data,  
        contentType: false,  
        cache: false,  
...
function viewBerkasPangkat(filename,id){
  ...
  function loadListRiwayatMutasiPidahMasuk(){
    $('#list_riwayat_karsu').html('')
    $('#list_riwayat_karsu').append(divLoaderNavy)
    $('#list_riwayat_karsu').load('<?=base_url("kepegawaian/C_Kepegawaian/getRiwayatLayananMutasiAsn/")?>'+id_m_layanan, function(){
      $('#loader').hide()
    })
    }
