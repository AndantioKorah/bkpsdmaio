<?php if(isset($result['code']) && $result['code'] == 1){ ?>
    ...
    <div class="modal fade" id="modal_cek_bangkom" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div id="modal-dialog" class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title">Rekap Data Bangkom SKPD</h6>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div id="modal_cek_bangkom_content">
                    <div class="row p-3">
                        <div class="col-lg-12 text-center">
                            <h4>Bangkom Belum Lengkap</h4>
                        </div>
                        <div class="col-lg-12">
                            <table class="table table-sm" id="table_bangkom_belum_lengkap">
                                <thead>
                                    <th class="text-center">No</th>
                                    <th class="text-center">Nama Pegawai</th>
                                    <?php if(in_array($result['id_unitkerja'], [3010000, 3012000])){ ?>
    ...
    <script>
        $(function(){
            $('.btn_download_pdf_tpp').hide()
            $('#table_bangkom_belum_lengkap').dataTable()
        })

        function openListBangkomTpp(){
            // $('#modal_cek_bangkom_content').html('')
            // $.ajax({
            //     url: '<?=base_url("rekap/C_Rekap/openListBangkomTpp")?>',
            //     method: 'post',
            //     data: {
            //         'list_pegawai' : '<?=json_encode($result['list_pegawai'])?>'
            //     },
            //     success: function(data){
            //         $('#loader').hide()
            //         $('#modal_cek_bangkom_content').append(data)
            //     }, error: function(e){
