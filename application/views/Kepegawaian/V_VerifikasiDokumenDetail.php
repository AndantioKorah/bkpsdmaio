  ...
  <div class="modal-body">
    <div class="row">
      ...
      <div class="col-lg-6 text-left">
        ...
        <span style="font-size: 1rem; font-weight: bold;"><?=getNamaPegawaiFull($result)?>  <span class="badge <?=$badge_status?>"> <?php  if($result['statuspeg'] == 1) echo "CPNS"; else if($result['statuspeg'] == 2) echo "PNS"; else if($result['statuspeg'] == 3) echo "PPPK"; else echo "PPPK Paruh Waktu";?> </span></span>
        </a>
      </div>
