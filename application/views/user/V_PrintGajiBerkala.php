<?php if($result){
$filename = 'List Pegawai Kenaikan Gaji Berkala.xls';
        ...
        <div class="col-lg-12">
            <table border=1 id="table_result" class="table table-hover datatable">
                <thead>
                    ...
                    <th style="text-align: center";>TMT Gaji Berkala</th>
                </thead>
                <tbody>
                    <?php $no = 1; foreach($result as $rs){ ?>
                        <tr>
                            ...
                            <td style="text-align: left" class="text-center"><?=formatDateOnly($rs['tmtgjberkala'])?></td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
