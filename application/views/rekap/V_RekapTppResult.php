                ...
                <div class="col-lg-12 row">
                    <div class="col-lg-4">
                        <form action="<?=base_url('rekap/C_Rekap/downloadBerkasTpp')?>" target="_blank" method="post">
                            ...
                            <?php //if(($data_search['tahun'] != 2025 && $data_search['bulan'] != "03") || $this->general_library->isProgrammer()){ ?>
                                <button id="btn_download_berkas" type="submit" class="btn btn-block btn-danger">
                                    <i class="fa fa-download"></i> Download as PDF
                                </button>
                            <?php// } else { ?>
                                <!-- <h5 style="font-weight: bold; color: red;">Rekap TPP belum dapat dilakukan karena masih menunggu rekap Kenegaraan pada Apel Perdana bulan Maret</h5> -->
                            <?php //} ?>
                            <?php // } ?>
                        </form>
                    </div>
