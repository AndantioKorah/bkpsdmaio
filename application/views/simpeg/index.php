...
<html lang="en">
    <head>
        ...
        <title>Lihat Dokumen PNS - Siladen</title>		
		<!-- Favicon -->
				...
				<div class="content container-fluid">				
					...
					<div class="card">
						<div class="card-header">
							<h4 class="card-title mb-0">Lihat Dokumen Kepegawaian Berdasarkan NIP</h4>
						</div>
						<div class="col-md-12">
							...
							<div class="card-body">									
								...
								<div class="form-group row">
									...
									<div class="col-md-6">
										<input type="text" name="cariName" id="cariName" class="form-control"  placeholder="Masukan Filter" value="<?php echo $data['nip_baru']?>" readonly>
									</div>
									<div class="col-md-2">
		...
		<script type="text/javascript">
			$(document).ready(function() {
				...
				var table = $('#table').DataTable({
					...
					"columns": [
						{ "data": "nama_dokumen","searchable": false,"orderable": true},
						{ "data": "nip","searchable": false,"orderable": true},
						{ "data": "nama_status","searchable": false,"orderable": false},
						{ "data": "first_name","searchable": false,"orderable": false},
