...
<div class="col-lg-12 mt-3">
	...
	<div class="col-lg-12">
		<div class="card card-default">
			...
			<input type="hidden" id="drh" value="<?php if($drh) echo $drh['id']; else echo "";?>">
			<input type="hidden" id="sk_jabatan" value="<?php if($sk_jabatan) echo $sk_jabatan['id']; else echo "";?>">
		
            <?php if($id_m_layanan == 37) { ?> 
			<input type="hidden" id="satyalancana_10" value="<?php if($satyalancana_10) echo $satyalancana_10['id']; else echo "";?>">
            <?php } ?>
            <?php if($id_m_layanan == 38) { ?> 
			<input type="hidden" id="satyalancana_10" value="<?php if($satyalancana_10) echo $satyalancana_10['id']; else echo "";?>">
			<input type="hidden" id="satyalancana_20" value="<?php if($satyalancana_20) echo $satyalancana_20['id']; else echo "";?>">
            <?php } ?>
...
$(function(){
  ...
  loadListRiwayatSatyalancana()
    ...
    $('#form_cpns_pns').on('submit', function(e){  
        ...
        var satyalancana_10 = $('#satyalancana_10').val()
        var satyalancana_20 = $('#satyalancana_20').val()
        ...
        $.ajax({  
        url:"<?=base_url("kepegawaian/C_Kepegawaian/insertUsulLayananSatyalancana/")?>"+id_m_layanan,
        method:"POST",  
        data:form_data,  
        contentType: false,  
        cache: false,  
...
function viewBerkasPangkat(filename,id){
  ...
  function loadListRiwayatSatyalancana(){
