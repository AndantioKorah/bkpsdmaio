...
<div class="col-md-12">
 ...
 <li class="nav-item nav-item-layanan" role="presentation">
    <button onclick="getFile(file='surat_pernyataan_hd')" class="nav-link nav-link-layanan" id="pills-pangkat-tab" data-bs-toggle="pill" data-bs-target="#pills-pangkat" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Surat Pernyataan Tidak Pernah Dijatuhi Hukuman Disiplin dari Perangkat Daerah</button>
  </li>
 
  <li class="nav-item nav-item-layanan" role="presentation">
    <button onclick="getFile(file='surat_pernyataan_pidana')" class="nav-link nav-link-layanan" id="pills-pangkat-tab" data-bs-toggle="pill" data-bs-target="#pills-pangkat" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Surat Pernyataan tidak sedang menjalani proses pidana penjara berdasarkan putusan pengadilan yang berkekuatan hukum tetap (bermaterai Rp. 10.000)</button>
  </li>
...
function openPresensiTab(){
  ...
  async function getFile(file){
    ...
    if(file == "skcpns" || file == "skpns"){
          ...
          dir = "./dokumen_layanan/suratpidanahukdis/";
        } else if(file == "ijazah"){
          dir = "./arsippendidikan/";
        }  else {
          dir = "uploads/";
