...
<div class="table-responsive">
<table id="example2" class="display table table-bordered" style="width:100%;color:#000" border="1">
        <thead>
            <tr>
		...
		<?php $no = 1; foreach($result as $rs2){ ?>
            ...
            href="#exampleModal2"  class="open-DetailPT">
                ...
                <td><?=$no++;?></td>
                <td><b><?=$rs2['gelar1'];?> <?=$rs2['nama'];?> <?=$rs2['gelar2'];?></b> <br> NIP. <?=formatNip($rs2['nipbaru_ws']);?><br><i></i></td>
<td><?=$rs2['jabatan_sekarang'];?></td>
