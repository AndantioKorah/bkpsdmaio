        ...
        <tbody>
          <?php $no = 1; foreach($result as $rs){ ?>
            <tr class="text-left">
              ...
              <td>
              <?php if($rs['id_m_layanan'] == '18') echo "Ujian Dinas Tingak I"; else if($rs['id_m_layanan'] == '19') echo "Ujian Dinas Tingkat II"; else if($rs['id_m_layanan'] == '20') echo "Ujian Penyesuaian Kenaikan Pangkat";?>  
              </td>
              <td class="text-left">
