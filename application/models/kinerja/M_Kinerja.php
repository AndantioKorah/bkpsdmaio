<?php
    ...
    public function baseQueryAtasan(){
        return $this->db->select('b.id_peg,a.id, b.gelar1, b.nipbaru_ws, b.nama, b.gelar2, c.nm_unitkerja, e.nm_pangkat, d.jenis_jabatan, b.handphone,
            a.id_m_bidang, c.id_unitkerja, c.id_unitkerjamaster, g.nama_bidang, a.id_m_sub_bidang, d.nama_jabatan, d.kepalaskpd, f.id_eselon, a.user_id_telegram,
    ...
    public function getAtasanPegawai($pegawai, $id_m_user = null, $flag_cuti = 0){
        ...
        if(isset($pegawai['nip_kepalaskpd_hardcode']) && $pegawai['nip_kepalaskpd_hardcode']){
            $hardcodeKepalaskpd = $this->db->select('a.nipbaru, a.nama, d.id_unitkerja, a.gelar1, a.gelar2, b.nm_pangkat, a.tmtpangkat,
                                        a.tmtcpns, d.nm_unitkerja, a.nipbaru_ws, e.id, a.handphone, e.user_id_telegram,
    ...
    public function countPaguTppNew($data, $id_pegawai = null, $flag_profil = 0, $flag_rekap_tpp = 0, $flag_sekolah_kecamatan = 0){
        $result = null;
        ...
        // } else {
            ...
            $this->db->select('a.nipbaru_ws, a.nama, a.gelar1, a.gelar2, b.nm_pangkat, f.id as id_m_user, b.kelas_jabatan_jfu, b.kelas_jabatan_jft, b.id_pangkat,
                        ...
                        g.beban_kerja AS beban_kerja_tambahan, g.kelas_jabatan as kelas_jabatan_tambahan, a.flag_bendahara,
                        g.kondisi_kerja AS kondisi_kerja_tambahan, a.statuspeg, e.id_unitkerja,
                        g.nama_jabatan AS nama_jabatan_tambahan, a.besaran_gaji, c.flag_override_tpp')
                        ->from('db_pegawai.pegawai a')
                        ->join('m_pangkat b', 'a.pangkat = b.id_pangkat')
                        ->join('db_pegawai.jabatan c', 'a.jabatan = c.id_jabatanpeg')
                        // ->join('db_pegawai.eselon d', 'c.eselon = d.nm_eselon')
        ...
        if($pegawai){
            ...
            foreach($pegawai as $p){
                ...
                } else if($data['id_unitkerja'] == 4012000){ // jika BAPELITBANG
                    if($p['jenis_jabatan'] == 'JFT'){
                        if(isContainSeq($p['nama_jabatan'], "Ahli Utama")){
                            $result[$p['id_m_user']]['beban_kerja'] = 17;
                            $result[$p['id_m_user']]['prestasi_kerja'] = 50;
                        ...
                        if($result[$p['id_m_user']]['kelas_jabatan'] == 6){
                            $result[$p['id_m_user']]['beban_kerja'] = 0;
                            $result[$p['id_m_user']]['prestasi_kerja'] = 49;
                            $result[$p['id_m_user']]['kondisi_kerja'] = 0;
                        }
                    }
