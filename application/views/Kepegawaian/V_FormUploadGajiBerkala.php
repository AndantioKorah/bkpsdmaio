...
$(function(){
  $(".select2").select2({   
    ...
    $('#list_gajiberkala').html('')
    $('#list_gajiberkala').append(divLoaderNavy)
    $('#list_gajiberkala').load('<?=base_url("Kepegawaian/C_Kepegawaian/loadListBerkala/")?>', function(){
      $('#loader').hide()
    })
  }
