	...
	<div class="col-lg-12">
		<div class="card card-default">
			...
			<div class="card-body">
				...
				<form id="form_dispensasi" method="post" enctype="multipart/form-data" id="form_cuti"
...
function viewBerkasPangkat(filename,id){
 ...
 $("#pdf_surat_kegiatan").change(function (e) {
      var fileSize = this.files[0].size/1024;
      var MaxSize = 1024

      var doc = pdf_surat_kegiatan.value.split('.')
      var extension = doc[doc.length - 1]
