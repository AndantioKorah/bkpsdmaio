...
<head>
	...
	<title>Antrian BKD - Siladen</title>
	<!-- Favicon -->
					...
					<div class="row align-items-center">
						<div class="col">
							...
							<ul class="breadcrumb">
								...
								<li class="breadcrumb-item active">Antrian Verifikasi Dokumen BKD</li>
							</ul>
						</div>
					</div>
				</div>
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title mb-0">Daftar Antrian Verifikasi Dokumen BKD</h4>
							</div>
							<div class="card-body">
								<div class="row">
									<div class="col">
	...
	<script type="text/javascript">
		$(document).ready(function() {
			var table = $('#table').DataTable({
				"sAjaxSource": "<?php echo site_url() ?>/arsip/getAntrianBKD",
				"sAjaxDataProp": "",
				"columns": [{
						"data": "nama_nip"
					},
