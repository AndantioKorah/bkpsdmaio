...
<div class="col-md-12">
  ...
  <li class="nav-item nav-item-layanan" role="presentation">
    <button onclick="getFile(file='suratpengantar')" class="nav-link nav-link-layanan" id="pills-pangkat-tab" data-bs-toggle="pill" data-bs-target="#pills-pangkat" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Surat Rekomendasi</button>
  <li>
  <li class="nav-item nav-item-layanan" role="presentation">
    <button onclick="getFile(file='peta_jabatan_mutasi_asn')" class="nav-link nav-link-layanan" id="pills-pangkat-tab" data-bs-toggle="pill" data-bs-target="#pills-pangkat" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Peta Jabatan</button>
  </li>
   ...
   $.ajax({
        ...
        if(data != ""){
          if(data[0].gambarsk != ""){
            ...
            } else if(file == "peta_jabatan_mutasi_asn"){
            var link = "<?=base_url();?>/"+dir+"/"+data[0].peta_jabatan+"?v="+number;
            } 
