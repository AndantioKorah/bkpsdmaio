    ...
    class M_General extends CI_Model
	{
        ...
        public function cekSidak(){
            ...
            $agenda = $this->db->select('a.id, a.judul, a.buka_masuk, a.tgl, d.id_unitkerja')
                            ->from('db_sip.sidak a')
                            ->join('db_sip.peserta_sidak b', 'a.id = b.sidak_id')
        ...
        public function editPdf(){
            ...
            $inputFile = 'arsipbkpsdmbacirita/sertifikat/_SERTIKAT9MARET2026.png';
            $outputFile = 'arsipbkpsdmbacirita/sertifikat/_SERTIKAT9MARET2026_preview.pdf';
