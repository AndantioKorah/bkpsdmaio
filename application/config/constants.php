...
define('LIST_ID_NEED_SUB_JABATAN', [
    "A5EB03E23DAAF6A0E040640A040252AD",
    "A5EB03E23DA7F6A0E040640A040252AD",
    "A5EB03E23DD0F6A0E040640A040252AD",
    "A5EB03E23DE9F6A0E040640A040252AD",
    "8ae482893580790801358a184e1848b9",
    "A5EB03E23DCFF6A0E040640A040252AD",
]);
...
// asli
// define('VERIF_PA_SKPDMASTER_YOURI', array(4000000,5007000,5008000,5011001,5008000,8000000));
// define('VERIF_PA_SKPDMASTER_ERICK', array(7005000,5009000,5002000));
// define('VERIF_PA_SKPDMASTER_TIO', array(5001000,1000000,2000000,5001000,5004000,5005000,5006000,5010001));
// define('VERIF_PA_SKPDMASTER_ONAL', array(6000000));
// define('VERIF_PA_SKPDMASTER_HARUN', array(3000000));
// define('VERIF_PA_SKPDMASTER_BOB', array(8010000,8020000));

// tambahan
define('VERIF_PA_SKPDMASTER_YOURI', array(4000000,5007000,5008000,5011001,5008000,8000000));
define('VERIF_PA_SKPDMASTER_ERICK', array(7005000,5009000,5002000, 5005000));
define('VERIF_PA_SKPDMASTER_TIO', array(5004000,2000000,5001000));
define('VERIF_PA_SKPDMASTER_ONAL', array(6000000, 5006000));
define('VERIF_PA_SKPDMASTER_HARUN', array(3000000, 5010001));
define('VERIF_PA_SKPDMASTER_BOB', array(8010000,8020000, 5001000,1000000));

define('VERIF_PA_SKPDIN_ONAL', array(6020000,6140000,6040000));
define('VERIF_PA_SKPDNOTIN_ONAL', array(6000000));

define('VERIF_PA_SKPDNOTIN_HARUN', array(6020000,6140000,6040000));
define('VERIF_PA_SKPDIN_HARUN', array(6000000));

define('BATAS_DETIK_AWAL_KONSULTASI', 3600);
define('BATAS_DETIK_AKHIR_KONSULTASI', 3600);
define('BATAS_DETIK_REPLY_KONSULTASI', 1800);
