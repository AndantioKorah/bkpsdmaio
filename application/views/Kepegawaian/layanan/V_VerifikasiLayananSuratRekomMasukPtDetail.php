...
<li class="nav-item nav-item-layanan" role="presentation">
 ...
 <li class="nav-item nav-item-layanan" role="presentation">
   ...
   <li class="nav-item nav-item-layanan" role="presentation">
    <button onclick="getFile(file='surat_rencana_kompetensi')" class="nav-link nav-link-layanan" id="pills-pangkat-tab" data-bs-toggle="pill" data-bs-target="#pills-pangkat" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Surat Rencana Kebutuhan Kompetensi </button>
  </li>
   <li class="nav-item nav-item-layanan" role="presentation">
    <button onclick="getFile(file='surat_pemberitahuan_mhs_baru')" class="nav-link nav-link-layanan" id="pills-pangkat-tab" data-bs-toggle="pill" data-bs-target="#pills-pangkat" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Surat Pemberitahuan Penerimaan Mahasiswa Baru </button>
  </li> 
...
function openPresensiTab(){
  ...
  async function getFile(file){
    ...
    if(file == "skcpns" || file == "skpns"){
          ...
          dir = "arsipskp/";
        } else if(file == "surat_pemberitahuan_mhs_baru" || file == "akreditasi" || file == "surat_rencana_kompetensi" || file == "transkrip" || file == "pak" || file == "ibel" || file == "sertiukom" || file == "forlap" || file== "stlud" || file== "uraiantugas" || file== "pangkalandata" || file == "skjabterusmenerus" || file == "transkrip" || file == "akreditasi_prodi"){
          dir = "arsiplain/";
        } else if(file == "diklat"){
          dir = "arsipdiklat/";
        } else if(file == "skjabatan"){
          dir = "arsipjabatan/";
        } else if(file == "suratpengantar" || file == "surat_pernyataan_hd" || file == "surat_pernyataan_pidana"){
          dir = "./dokumen_layanan/suratrekompt/";
        } else if(file == "ijazah"){
          dir = "./arsippendidikan/";
        }  else {
          dir = "uploads/";
...
async function openDokumen(filename){
